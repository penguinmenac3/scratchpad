...
export class Toolbar {
  public constructor(
    ...
    new ToolSelector(mainDiv, "undo", '<i class="fa fa-undo" aria-hidden="true"></i>')
    new ToolSelector(mainDiv, "redo", '<i class="fa fa-repeat" aria-hidden="true"></i>')
    new ToolSelector(mainDiv, "settings", '<i class="fa fa-bars" aria-hidden="true"></i>')
  }
}
